...
<article>
    <div class="grid">
            ...
            <?php if ($sitemapExists): ?>
                ...
                <div style="margin-top: 1rem;">
                    <a href="/sitemap.xml" target="_blank" role="button" class="secondary outline btn-sm">Görüntüle
                        (XML)</a>
                    <a href="/App\Core\Modules\System\Views\sitemap\view" role="button" class="secondary outline btn-sm">İncele</a>
                </div>
            <?php else: ?>
        ...
        <div style="border-left: 1px solid var(--pico-muted-border-color); padding-left: 2rem;">
            <h5>İşlemler</h5>
            <form action="/App\Core\Modules\System\Views\sitemap\generate" method="post" style="display: inline-block;">
                <?= csrf_field() ?>
            ...
            <?php if ($sitemapExists): ?>
                <a href="/App\Core\Modules\System\Views\sitemap\delete" role="button" class="contrast outline" style="margin-left: 1rem;"
