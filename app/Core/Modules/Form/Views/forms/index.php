...
<div class="grid">
    ...
    <div style="text-align: right;">
        <a href="/App\Core\Modules\Form\Views\forms\create" role="button" class="primary">
                    ...
                    <?php foreach ($forms as $form): ?>
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <a href="/App\Core\Modules\Form\Views\forms\<?= $form->id ?>/submissions" role="button" class="outline btn-sm">
                                    Görüntüle
                                </a>
                            </td>
                            <td style="text-align: right;">
                                <div role="group">
                                    <a href="/App\Core\Modules\Form\Views\forms\edit/<?= $form->id ?>" role="button" class="secondary outline btn-sm">
                                        <i class="fa-solid fa-pen"></i>
                                    </a>
                                    <a href="#" hx-get="/App\Core\Modules\Form\Views\forms\delete/<?= $form->id ?>"
