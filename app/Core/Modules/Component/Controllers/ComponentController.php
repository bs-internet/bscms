...
class ComponentController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('App\Core\Modules\Component\Views/index', ['components' => $components]);
    }

    public function create()
    {
        $contentTypes = $this->contentTypeRepository->getAll();
        return view('App\Core\Modules\Component\Views/create', [
    ...
    public function edit(int $id)
    {
        ...
        return view('App\Core\Modules\Component\Views/edit', [
            'component' => $component,
            'fields' => $fields,
            'locations' => $locations,
            'contentTypes' => $contentTypes,
